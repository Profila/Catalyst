...
import Contract.Monad (defaultDatumCacheWsConfig, defaultOgmiosWsConfig, defaultServerConfig, liftContractM, runContract)
import Contract.Prelude (Effect, Maybe(..), Unit, bind, wrap, ($), (=<<), (/\))
...
-- Important: When you are copying a compiled script here, you need to delete the first 6 characters
