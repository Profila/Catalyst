...
let
  inputs = {
    ...
    "cardano-transaction-lib" = pkgs.stdenv.mkDerivation {
        ...
        version = "78f1b4f7b3204923a0b71473b7fea3dd867beb44";
        src = pkgs.fetchgit {
          url = "https://github.com/Plutonomicon/cardano-transaction-lib.git";
          rev = "78f1b4f7b3204923a0b71473b7fea3dd867beb44";
          sha256 = "092jbf34mzqkjsl28vwj77dpv2i502jwhv88jzaa5nmfisc8acq4";
        };
        phases = "installPhase";
        installPhase = "ln -s $src $out";
      };
